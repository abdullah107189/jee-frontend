...
import type { SellerWarranty } from "@/services/seller.service";
import {
  ShieldCheck,
  ArrowLeft,
  User,
...
export default function SellerWarrantyDetailsPage({ warranty }: { warranty: SellerWarranty }) {
  return (
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-500 font-medium">
              Digital Guarantee Record #{warranty?.id}
            </p>
          </div>
        </div>
