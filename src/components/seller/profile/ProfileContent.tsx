...
import { changeSellerPasswordAction, updateSellerProfileAction } from '@/actions/seller.actions';
...
export default function SellerProfilePage({ profile }: { profile: SellerProfile }) {
  ...
  const handleSavePassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await changeSellerPasswordAction({ currentPassword, newPassword });
