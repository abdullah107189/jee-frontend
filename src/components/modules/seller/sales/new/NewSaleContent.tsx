...
import { recordOfflineSaleAction, validateProductItemAction } from '@/actions/seller.actions';
...
export default function SellerNewSalePage() {
  ...
  const handleSearch = async () => {
    ...
    try {
      setIsFetching(true);
      const res = await validateProductItemAction(uniqueId);
      setProductData(res);
  ...
  const handleSubmitSale = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await recordOfflineSaleAction(payload);
