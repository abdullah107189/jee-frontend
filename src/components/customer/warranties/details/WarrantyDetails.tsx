...
import { claimWarrantyAction } from "@/actions/customer.actions";
import type { CustomerWarrantyDetails } from "@/services/customer.service";
...
export function WarrantyDetails({ warranty }: { warranty: CustomerWarrantyDetails }) {
      ...
      {showClaimForm && (
        <ClaimForm
          ...
          onSubmit={async (data) => {
            setIsClaiming(true);
            try {
              await claimWarrantyAction({ ...data, warrantyId: warranty.id });
            } finally {
              setIsClaiming(false);
            }
          }}
