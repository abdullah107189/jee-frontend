...
import type { SellerDashboardStats, SellerSale } from '@/services/seller.service';
...
export function SellerDashboard({ stats, recentSales }: { stats: SellerDashboardStats; recentSales: SellerSale[] }) {
